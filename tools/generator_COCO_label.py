...
from core.generator_engine import generate_inference
...
def parse_args():
    ...
    parser.add_argument(
        '--proposal_file',
        help='target dataset proposal file')
...
if __name__ == '__main__':
    ...
    if args.dataset == "voc_2007_trainval":
        cfg.TEST.DATASETS = ('voc_2007_trainval',)
        cfg.MODEL.NUM_CLASSES = 20
    elif args.dataset == "voc_2007_test":
        cfg.TEST.DATASETS = ('voc_2007_test',)
        cfg.MODEL.NUM_CLASSES = 20
    elif args.dataset == "voc_2012_trainval":
