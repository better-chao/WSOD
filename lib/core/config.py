...
__C.TRAIN.DYNAMIC_TYPE = "constant"

__C.TRAIN.STATIC_LOSS = False

__C.TRAIN.TOP_TO_DOWN = False

__C.TRAIN.EXPAND_GT = False

__C.TRAIN.DEBUG = False

__C.TRAIN.NORMAL = False

__C.TRAIN.UPDATE_RATE = 1.0

__C.TRAIN.EXP_TEMP = 1.0

__C.TRAIN.WSOD_REWEIGHT = False

__C.TRAIN.RESET = False

__C.TRAIN.THRESHOLD = 0.5

__C.TRAIN.LABEL_UPDATE = False

__C.TRAIN.UPDATE_PER_TIME = 1

__C.TRAIN.REWEIGHT_EPOCH = 5
...
# ---------------------------------------------------------------------------- #
# Inference ('dropblock') options
# ---------------------------------------------------------------------------- #
__C.DROPBLOCK = AttrDict()

__C.DROPBLOCK.SWITCH = False

__C.DROPBLOCK.BLOCK_TYPE = "DROP_BLOCK"

__C.DROPBLOCK.DROP_PROB = 0.3

__C.DROPBLOCK.BLOCK_SIZE = 3

__C.DROPBLOCK.GSM_THRES = 0.01

__C.DROPBLOCK.IS_HARD = True



__C.SLV = AttrDict()

__C.SLV.SWITCH = False
__C.SLV.SLV_M_THRES = (0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.2, 0.5, 0.5, 0.5, 0.5, 0.5)
__C.SLV.SLV_prior_thres = 0.95
__C.SLV.param_path = "/opt/data/nfs/zh/package/VOC_gamma_theta.npy"
__C.SLV.BAND_WIDTH = 0.005

__C.SLV.degree_add = False
__C.SLV.WARMUP_STEP = [0, 35000]
__C.SLV.warmup_prior = 0.05


__C.CDBLOCK = AttrDict()
__C.CDBLOCK.SWITCH = False
__C.CDBLOCK.CONV_ATT = True
__C.CDBLOCK.TYPE = 2
__C.CDBLOCK.CHANNEL_ATT = False

__C.SUP = AttrDict()
__C.SUP.SWITCH = False

__C.SUP.FASTER_MULTI_CENTERS = False
__C.SUP.FASTER_SUB_CAT = False
__C.SUP.FASTER_EXPAND = False
__C.SUP.FASTER_MERGE = False
__C.SUP.FASTER_REMOVE = False
__C.SUP.FASTER_REWEIGHT = False

__C.SUP.ADD_NEG_LOSS = False
__C.SUP.NEG_WEIGHT = 0.0

__C.SUP.SEMI = True

__C.SUP.OICR_MULTI_CENTERS = False
__C.SUP.OICR_SUB_CAT = False
__C.SUP.OICR_EXPAND = False
__C.SUP.OICR_MERGE = False
__C.SUP.OICR_REMOVE = False
__C.SUP.OICR_REWEIGHT = False


__C.SUP.SUB_APPLY = False


__C.NONLOCAL = AttrDict()

__C.NONLOCAL.SWITCH = False

__C.NONLOCAL.SUB_SAMPLE = False

__C.NONLOCAL.BN_LAYER = False


__C.ACOL = AttrDict()

__C.ACOL.SWITCH = False

__C.ACOL.THRES = 0.85

__C.ADL = AttrDict()
__C.ADL.SWITCH = False
__C.ADL.PRETRAIN = False


__C.SPLITE = AttrDict()

__C.SPLITE.SWITCH = False
...
__C.TEST.MODEL = "Generalized_RCNN"
...
#   Valid options: ('ID', 'AVG', 'UNION')
__C.TEST.BBOX_AUG.COORD_HEUR = 'AVG'

# Horizontal flip at the original scale (id transform)
__C.TEST.BBOX_AUG.H_FLIP = True

# Each scale is the pixel size of an image's shortest side
__C.TEST.BBOX_AUG.SCALES = (576, 688, 864, 1000, 1200)
...
__C.MODEL.WITH_FRCNN = False


__C.MODEL.WITH_BLOB_LOSS = False

__C.MODEL.BLOB_LOSS_THRES = 0.3

__C.MODEL.WITH_BLOB_CONV = False
...
# print("__C.ROOT_DIR:", __C.ROOT_DIR)   # /gpfsdata/home/zenghao/pcl
# __C.ROOT_DIR = "/home/zenghao/pcl"
...
# print("__C.DATA_DIR:", __C.DATA_DIR)
# [Deprecate]
