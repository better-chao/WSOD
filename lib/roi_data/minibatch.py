...
def get_minibatch_blob_names(is_training=True):
    ...
    blob_names = ['data', 'rois', 'labels', 'gt_boxes', 'gt_boxes_classes']
    return blob_names
...
def get_minibatch(roidb, num_classes):
    ...
    blobs['gt_boxes'] = roidb[0]["gt_boxes"] * im_scales[0]
    blobs['gt_boxes_classes'] = roidb[0]["gt_boxes_classes"]
    blobs['history_label'] = roidb[0]["history_label"]
    blobs['image_name'] = roidb[0]['image']
